    ...
    <b-container fluid>
      <b-row>
        <b-col>
          ...
          <b-container id="who-description-container">
            <p>
...
#logo-name .title h1.first-row span {
  background-color: #4d4444;
  position: relative;
  right: 20%;
}

#logo-name .title h1.second-row span {
  background-color: #4d4444;
  position: relative;
  left: 10%;
}

#logo-name .title h1.second-row::first-letter {
  color: #f800ae;
}
